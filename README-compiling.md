...
* `services/gdp-directoryd`: the directory mapping internal GDPnames
  (256-bit binary numbers) to server names (where the indicated name
  can be found).  The database is highly dynamic, and the
