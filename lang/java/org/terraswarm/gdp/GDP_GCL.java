...
public class GDP_GCL {
    ...
    public static void create(GDP_NAME logName, GDP_NAME logdName, 
        ...
        estat = Gdp05Library.INSTANCE.gdp_gcl_create(logNameInternal, logdNameInternal,
    ...
    public GDP_GCL(GDP_NAME name, GDP_MODE iomode) {
        ...
        // open the GCL
        estat = Gdp05Library.INSTANCE.gdp_gcl_open(ByteBuffer.wrap(this.gclname), 
    ...
    public void finalize() {
        ...
        Gdp05Library.INSTANCE.gdp_gcl_close(this.gclh);
    ...
    public HashMap<String, Object> read(long recno) {
        ...
        estat = Gdp05Library.INSTANCE.gdp_gcl_read(this.gclh, recno, 
                                datum.gdp_datum_ptr);
        GDP.check_EP_STAT(estat);
    ...
    public void append(Map<String, Object>datum_dict) {
        ...
        estat = Gdp05Library.INSTANCE.gdp_gcl_append(this.gclh,
                                datum.gdp_datum_ptr);
        GDP.check_EP_STAT(estat);
    ...
    public void append_async(Map<String, Object>datum_dict) {
        ...
        estat = Gdp05Library.INSTANCE.gdp_gcl_append_async(this.gclh, 
    ...
    //     if (ev.type == Gdp05Library.INSTANCE.GDP_EVENT_DATA) {
    ...
    public static HashMap<String, Object> _helper_get_next_event(
        ...
        EP_STAT event_ep_stat = Gdp05Library.INSTANCE
                            .gdp_event_getstat(gdp_event_ptr);
        PointerByReference _gclhByReference = Gdp05Library.INSTANCE
        ...
        Gdp05Library.INSTANCE.gdp_event_free(gdp_event_ptr);
    ...
    //     PointerByReference gev = Gdp05Library.INSTANCE
    //                                 .gdp_event_next(this.gclh, timeout);

    //     // Get the data associated with this event
    //     int type = Gdp05Library.INSTANCE.gdp_event_gettype(gev);
    //     PointerByReference datum = Gdp05Library.INSTANCE.gdp_event_getdatum(gev);
    ...
    //     Gdp05Library.INSTANCE.gdp_event_free(gev);
